...
from .views import GenerateAPITokenView, RevokeAPITokenView, ProfileAccountView, ProfileAPITokenView, \
    WizardCompleteView, GithubCallbackView, GithubIntegrationView, SlackIntegrationView, PaymentPlanView
...
urlpatterns = [
    ...
    path('profile/password/', PasswordChangeView.as_view(
        ...
        extra_context={'tab_password': 'active'}), name='profile_password'),
